		...
		<div class="site-container">
			...
			<div class="site-branding">
				...
				<?php if ( get_header_image() ) : ?>
			    	...
			    	<?php if ( get_theme_mod( 'vogue-header-image-show-title', customizer_library_get_default( 'vogue-header-image-show-title' ) ) ) : ?>
					...
					<?php endif; ?>
			    	<?php if ( get_theme_mod( 'vogue-header-image-show-tagline', customizer_library_get_default( 'vogue-header-image-show-tagline' ) ) ) : ?>
